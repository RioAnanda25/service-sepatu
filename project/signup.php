...
<html lang="id" class="scroll-smooth">
  <head>
    ...
    <title>Register | The Clean - Sistem Informasi Service Sepatu</title>
  ...
  <body class="bg-white text-gray-800 dark:bg-slate-900 dark:text-gray-100">
        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full px-4">
            <div class="text-center">
              <h1 class="text-3xl font-bold text-white sm:text-4xl">Register</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="bg-[#F4F7FF] py-14 lg:py-20 dark:bg-slate-900">
      <div class="container px-4 mx-auto">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4">
            <div class="wow fadeInUp mx-auto max-w-[525px] overflow-hidden rounded-xl bg-white py-14 px-8 text-center sm:px-12 md:px-[60px] shadow-md dark:bg-slate-800 border dark:border-slate-700" data-wow-delay=".15s">
              ...
              <form action="proses_register.php" method="POST">
                ...
                <div class="mb-10">
                  <button
                    type="submit"
                    name="register"
                    class="w-full flex items-center justify-center gap-3 cursor-pointer rounded-md border border-blue-600 bg-blue-600 px-5 py-3 text-base font-medium text-white transition hover:bg-blue-700"
                  >
                    <span>Register</span>
                  </button>
                </div>
              ...
              <p class="text-base text-gray-500 dark:text-gray-400">
                Sudah punya akun?
                <a href="signin.php" class="text-blue-600 hover:underline">
                  Login di sini
                </a>
              </p>
            </div>
    ...
    <footer id="contact" class="relative z-10 bg-[#090E34] pt-20 lg:pt-[120px] text-gray-300 overflow-hidden">
      <div class="absolute left-0 top-12 -z-10 h-80 w-80 rounded-full bg-gradient-to-tr from-blue-500/10 to-teal-400/20 blur-3xl pointer-events-none"></div>
      <div class="absolute right-0 bottom-0 -z-10 h-72 w-72 rounded-full bg-gradient-to-br from-green-500/20 to-cyan-400/20 blur-3xl pointer-events-none"></div>
    ...
    <a
      ...
      class="fixed left-auto items-center justify-center hidden w-10 h-10 text-white transition duration-300 ease-in-out rounded-md shadow-md back-to-top bottom-8 right-8 z-999 bg-blue-600 hover:bg-blue-700"
    >
      <span class="mt-[6px] h-3 w-3 rotate-45 border-t border-l border-white"></span>
    </a>

    <script>
      // SCRIPT ANIMASI NAVBAR DAN DARK MODE SAJA
      window.onscroll = function () {
        const ud_header = document.querySelector(".ud-header");
        const logo = document.querySelector(".navbar-logo");
        const navLinks = ud_header.querySelectorAll("nav ul li a");
        // AMAN: Selector diganti menargetkan file .php
